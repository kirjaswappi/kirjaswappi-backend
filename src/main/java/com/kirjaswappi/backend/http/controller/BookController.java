...
import static com.kirjaswappi.backend.common.util.Constants.BOOKS;
import static com.kirjaswappi.backend.common.util.Constants.ID;
import static com.kirjaswappi.backend.common.util.Constants.SUPPORTED_CONDITIONS;
import static com.kirjaswappi.backend.common.util.Constants.SUPPORTED_LANGUAGES;
...
import com.kirjaswappi.backend.common.util.LinkBuilder;
import com.kirjaswappi.backend.http.dto.request.CreateBookRequest;
import com.kirjaswappi.backend.http.dto.request.UpdateBookRequest;
import com.kirjaswappi.backend.http.dto.response.BookListResponse;
import com.kirjaswappi.backend.http.dto.response.BookResponse;
