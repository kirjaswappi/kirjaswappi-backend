...
import com.kirjaswappi.backend.http.dto.request.AuthenticateUserRequest;
import com.kirjaswappi.backend.http.dto.request.ChangePasswordRequest;
import com.kirjaswappi.backend.http.dto.request.CreateUserRequest;
import com.kirjaswappi.backend.http.dto.request.ResetPasswordRequest;
import com.kirjaswappi.backend.http.dto.request.UpdateUserRequest;
import com.kirjaswappi.backend.http.dto.request.VerifyEmailRequest;
import com.kirjaswappi.backend.http.dto.response.ChangePasswordResponse;
import com.kirjaswappi.backend.http.dto.response.CreateUserResponse;
import com.kirjaswappi.backend.http.dto.response.ResetPasswordResponse;
import com.kirjaswappi.backend.http.dto.response.UpdateUserResponse;
import com.kirjaswappi.backend.http.dto.response.UserResponse;
import com.kirjaswappi.backend.http.dto.response.VerifyEmailResponse;
